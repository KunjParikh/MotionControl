...
def kalmanFilter(z_c, dz, r, z_r, r_c, r_c_old, p, hessian, numSensors,  model = False):
...
class Shape:
    ...
    def step(self, state, t, model=False):
        ...
        if model:
            # z_c_k, dz_c_k, p_k, data = kalmanFilter(z_c, dz_c, r, z_r, r_c, r_c_old, p, hessian, self.numSensors)
            z_c_p, dz_c_p, p_p, data = kalmanFilter(z_c, dz_c, r, z_r, r_c, r_c_old, p, hessian, self.numSensors, model)
            ...
            z_c, dz_c, p, data = kalmanFilter(z_c, dz_c, r, z_r, r_c, r_c_old, p, hessian, self.numSensors)
        # z_c = f(r_c[0], r_c[1])
